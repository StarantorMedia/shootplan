...
function ProfilePage({ user, setUser }) {
  ...
  const handleSaveName = async () => {
    ...
    try {
      ...
      setUser(u => ({ ...u, name: nameForm.name.trim() }));
...
// ============================================================
function MarketplacePage({ user, users }) {
  ...
  return (
    <div>
      <div style={S.pageHeader}>
        ...
        <button style={S.btn("primary")} onClick={() => setShowAddModal(true)}>＋ Equipment vermieten</button>
      </div>
...
export default function App() {
  ...
  const content = loading ? (
    ...
    <>
      ...
      {page === "marketplace" && <MarketplacePage user={user} users={users} />}
